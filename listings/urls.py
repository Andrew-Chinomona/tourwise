...
from .views import add_property_step1, add_property_step2, add_property_step3, add_property_step4, add_property_step5, add_property_step6, add_property_step7, add_property_step8, choose_payment, edit_listing, delete_listing, delete_property_image, upload_property_images
